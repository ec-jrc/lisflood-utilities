...
def main():
    ...
    ncfile_pr = initialize_netcdf(os.path.join(scratchoutdir,'tp.nc'),template_lat,template_lon,'tp','mm d-1',1)
    ...
    if petc=="1":
        ...
        ncfile_rn = initialize_netcdf(os.path.join(scratchoutdir,'rn.nc'),template_lat,template_lon,'rn','J m-2 d',1)
        ncfile_ws = initialize_netcdf(os.path.join(scratchoutdir,'ws.nc'),template_lat,template_lon,'ws','m s-1',1)
        ncfile_rgd = initialize_netcdf(os.path.join(scratchoutdir,'rgd.nc'),template_lat,template_lon,'rgd','J m-2 d',1)
        ncfile_td = initialize_netcdf(os.path.join(scratchoutdir,'td.nc'),template_lat,template_lon,'td','degree_Celsius',1)
    ...
    for file in files:
        ...
        # fill the values with NA where condition is false, where there should be NaN
            ...
            ncfile_pr.variables['tp'][index,:,:] = data['pr']
            ...
            if petc=="1": 
                ...
                ncfile_ws.variables['time'][index] = time_value
                ...
                ncfile_td.variables['time'][index] = time_value
