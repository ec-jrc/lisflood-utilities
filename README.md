...
* __meteo-forcing__ is a package containing scripts that allow to generate daily meteorological input files for the LISFLOOD hydrological model. The package consists of several similar scripts tailored to different input meteorological datasets, such as ISIMIP3b, W5E5, ERA5-land and MSWX/MSWEP
