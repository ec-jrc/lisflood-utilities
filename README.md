...
- file .yaml to define the metadata of the output water regions map in netcdf format. An example of the structure of this file is provided [here](../lisflood-utilities/tests/data/waterregions/metadata_test.yaml)
