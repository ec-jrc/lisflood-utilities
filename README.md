...
1. [Thematic Mapping](https://thematicmapping.org/downloads/world_borders.php) country borders shape file rasterized to 0.01° using `gdal_rasterize -l TM_WORLD_BORDERS-0.3 -a UN -tr 0.01 0.01 -a_nodata 0.0 -te -180.0 -90.0 180.0 90.0 -ot Float32 -of GTiff TM_WORLD_BORDERS-0.3.shp TM_WORLD_BORDERS_UN_rasterized_.tif`. Put the output in `world_borders_folder`.
...
```
git clone https://github.com/hylken/lisflood-dynamic-water-demand-historic
cd lisflood-dynamic-water-demand-historic
```
